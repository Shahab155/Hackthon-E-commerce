        ...
        <div className=' max-w-[1330px] h-[90px] hidden md:flex justify-evenly items-center'>
          ...
          <div className='max-w-[815px] h-[58px] flex justify-between items-center '>
           ...
           <div className='w-[300px] flex gap-[45px]'>
            <button className='text-[#23A6F0] text-sm font-[700]'>Login</button>
            <button className='btnLg w-[230px] rounded-md flex justify-center items-center  gap-[15px]'>Become a member <i className="bi bi-arrow-right-short text-white font-bold text-2xl"></i></button>
