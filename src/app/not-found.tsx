...
export default function Custom404() {
  ...
  return (
   ...
   <button onClick={()=>route.push('/')} className="px-8 py-3 bg-blue-500 text-white font-[700] rounded-sm shadow-black shadow-md hover:bg-blue-700 hover:transition-colors ">
   Back to Home
    </button>
   </div>
