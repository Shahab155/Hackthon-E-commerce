  ...
  return (
    <>
      ...
      <nav className="bg-[#FFF] shadow-sm shadow-secondary">
        <div className={`mx-auto max-w-[1330px] h-[90px] hidden md:flex ${!user ? 'justify-evenly': 'justify-between' }  items-center`}>
          <div>
            <h1 className="px-6 text-2xl text-primary font-[700]">Bandage</h1>
          </div>
          <div className="max-w-[815px] h-[58px] flex justify-between items-center ">
            ...
            <div className="w-[300px] flex gap-[45px] items-center">
              ...
              <button onClick={()=>{router.push("/sign-up")}} className="btnLg w-[230px] rounded-md flex justify-center items-center  gap-[15px]">
                Become a member{" "}
