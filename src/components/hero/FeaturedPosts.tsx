  ...
  return (
    <>
      ...
      <div className="flex  my-10">
        <div className="mx-auto max-w-[1044px] flex flex-col items-center gap-20 justify-center ">
          ...
          <div className="font-[700] text-center w-full  flex flex-col items-center gap-[10px]">
            ...
            <h2 className="text-[32px] md:text-[40px] text-primary ">
              Featured Posts
            </h2>
            <p className="w-[90%] md:w-[469px]  text-sm font-[400] text-secondary">
